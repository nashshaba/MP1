...
model1_points <- model1 %>% 
  broom::augment()
training_plot1 <- ggplot(ptrain1, aes(x = predictor, y = outcome)) +
  geom_point()
training_plot1 +
...
model2_points <- model2 %>% 
  broom::augment()
training_plot2 <- ggplot(ptrain2, aes(x = predictor, y = outcome)) +
  geom_point()
training_plot2 +
  geom_line(data = model1_points, aes(x = x, y = .fitted), col = "blue", size = 1)
...
model3_points <- model3 %>% 
  broom::augment()
training_plot3 <- ggplot(ptrain3, aes(x = predictor, y = outcome)) +
  geom_point()
training_plot3 +
  geom_line(data = model1_points, aes(x = x, y = .fitted), col = "blue", size = 1)
...
model4_points <- model4 %>% 
  broom::augment()
training_plot4 <- ggplot(ptrain4, aes(x = predictor, y = outcome)) +
  geom_point()
training_plot4 +
...
model5_points <- model5 %>% 
  broom::augment()
training_plot5 <- ggplot(ptrain5, aes(x = predictor, y = outcome)) +
  geom_point()
training_plot5 +
...
mRMSE <- c(0.3187564,0.315039,0.3149522,0.314817,0.3147375,0.3147397,0.3148387,0.315039,0.3327549)

new_df <- data.frame(df,mRMSE)
as_tibble(new_df)

plot_df <- ggplot(new_df,aes(x=df,y=mRMSE))+
  geom_point()
